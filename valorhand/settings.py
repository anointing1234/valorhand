"""
Django settings for valorhand project.
...
ROOT_URLCONF = 'valorhand.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS':  [os.path.join(BASE_DIR,'valor_dash','templates','accounts','templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'valorhand.wsgi.application'
